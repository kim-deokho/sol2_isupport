	...
	<div class="modal_contents">
		...
		<div class="three_areas">
			...
			<div class="second_area mWt10p">
				<div class="arrow_button mt100" onclick=""><img src="../common/img/right_arrow.png" alt="오른쪽" /></div>
		...
		<div class="three_areas">
			...
			<div class="second_area mWt10p">
				<div class="arrow_button mt30" onclick=""><img src="../common/img/right_arrow.png" alt="오른쪽" /></div>
				<div class="arrow_button mt10" onclick=""><img src="../common/img/left_arrow.png" alt="왼쪽" /></div>
			</div> <!-- second_area -->
