<style type="text/css">
	#pop_change_grade {max-width: 600px;}    
    #pop_change_grade .file_wrap > span.file_val {width: calc(100% - 180px);}
    #pop_change_grade .y_over {max-height:200px;overflow-y:auto;}
</style>

<div id="pop_change_grade" class="modal">
