<style type="text/css">
	#pop_authority_reg {max-width: 350px;}
</style>

<div id="pop_authority_reg"  class="modal">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<label class="radioWrap ml30"><input type="radio" name="사용유무" value=""  /><i></i><span>N</span></label>
						</td>
					</tr>							
				</tbody>
		  </table> <!-- itable_1 -->
